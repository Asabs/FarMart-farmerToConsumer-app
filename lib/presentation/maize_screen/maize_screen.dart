import '../maize_screen/widgets/maize_item_widget.dart';
import 'bloc/maize_bloc.dart';
import 'models/maize_item_model.dart';
import 'models/maize_model.dart';
...
class MaizeScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MaizeBloc>(
      create: (context) => MaizeBloc(MaizeState(
        maizeModelObj: MaizeModel(),
      ))
        ..add(MaizeInitialEvent()),
      child: MaizeScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<MaizeBloc, MaizeState,
                      ...
                      SizedBox(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: Alignment.center,
                              child: BlocSelector<MaizeBloc, MaizeState,
                                  MaizeModel?>(
                                selector: (state) => state.maizeModelObj,
                                builder: (context, maizeModelObj) {
                                  return ListView.separated(
                                    ...
                                    itemCount:
                                        maizeModelObj?.maizeItemList.length ??
                                            0,
                                    itemBuilder: (context, index) {
                                      MaizeItemModel model =
                                          maizeModelObj?.maizeItemList[index] ??
                                              MaizeItemModel();
                                      return MaizeItemWidget(
                                        model,
                                      );
                                    },
                                  );
