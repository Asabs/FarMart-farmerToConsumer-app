import '../mango_one_screen/widgets/mango_one_item_widget.dart';
import 'bloc/mango_one_bloc.dart';
import 'models/mango_one_item_model.dart';
import 'models/mango_one_model.dart';
...
class MangoOneScreen extends StatelessWidget {
  MangoOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MangoOneBloc>(
      create: (context) => MangoOneBloc(MangoOneState(
        mangoOneModelObj: MangoOneModel(),
      ))
        ..add(MangoOneInitialEvent()),
      child: MangoOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<MangoOneBloc, MangoOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<MangoOneBloc, MangoOneState,
                              MangoOneModel?>(
                            selector: (state) => state.mangoOneModelObj,
                            builder: (context, mangoOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    mangoOneModelObj?.mangoOneItemList.length ??
                                        0,
                                itemBuilder: (context, index) {
                                  MangoOneItemModel model = mangoOneModelObj
                                          ?.mangoOneItemList[index] ??
                                      MangoOneItemModel();
                                  return MangoOneItemWidget(
                                    model,
                                  );
                                },
                              );
