import '../pineapple_screen/widgets/pineapple_item_widget.dart';
import 'bloc/pineapple_bloc.dart';
import 'models/pineapple_item_model.dart';
import 'models/pineapple_model.dart';
...
class PineappleScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PineappleBloc>(
      create: (context) => PineappleBloc(PineappleState(
        pineappleModelObj: PineappleModel(),
      ))
        ..add(PineappleInitialEvent()),
      child: PineappleScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<PineappleBloc, PineappleState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<PineappleBloc, PineappleState,
                              PineappleModel?>(
                            selector: (state) => state.pineappleModelObj,
                            builder: (context, pineappleModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: pineappleModelObj
                                        ?.pineappleItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  PineappleItemModel model = pineappleModelObj
                                          ?.pineappleItemList[index] ??
                                      PineappleItemModel();
                                  return PineappleItemWidget(
                                    model,
                                  );
                                },
                              );
