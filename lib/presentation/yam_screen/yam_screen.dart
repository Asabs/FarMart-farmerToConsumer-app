import '../yam_screen/widgets/yam_item_widget.dart';
import 'bloc/yam_bloc.dart';
import 'models/yam_item_model.dart';
import 'models/yam_model.dart';
...
class YamScreen extends StatelessWidget {
  YamScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<YamBloc>(
      create: (context) => YamBloc(YamState(
        yamModelObj: YamModel(),
      ))
        ..add(YamInitialEvent()),
      child: YamScreen(),
    );
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<YamBloc, YamState, YamModel?>(
                            selector: (state) => state.yamModelObj,
                            builder: (context, yamModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: yamModelObj?.yamItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  YamItemModel model =
                                      yamModelObj?.yamItemList[index] ??
                                          YamItemModel();
                                  return YamItemWidget(
                                    model,
                                  );
                                },
                              );
