import '../millet_screen/widgets/millet_item_widget.dart';
import 'bloc/millet_bloc.dart';
import 'models/millet_item_model.dart';
import 'models/millet_model.dart';
...
class MilletScreen extends StatelessWidget {
  MilletScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<MilletBloc>(
      create: (context) => MilletBloc(MilletState(
        milletModelObj: MilletModel(),
      ))
        ..add(MilletInitialEvent()),
      child: MilletScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<MilletBloc, MilletState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<MilletBloc, MilletState,
                              MilletModel?>(
                            selector: (state) => state.milletModelObj,
                            builder: (context, milletModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    milletModelObj?.milletItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  MilletItemModel model =
                                      milletModelObj?.milletItemList[index] ??
                                          MilletItemModel();
                                  return MilletItemWidget(
                                    model,
                                  );
                                },
                              );
