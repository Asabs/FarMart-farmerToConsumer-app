import '../coconut_screen/widgets/coconut_item_widget.dart';
import 'bloc/coconut_bloc.dart';
import 'models/coconut_item_model.dart';
import 'models/coconut_model.dart';
...
class CoconutScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<CoconutBloc>(
      create: (context) => CoconutBloc(CoconutState(
        coconutModelObj: CoconutModel(),
      ))
        ..add(CoconutInitialEvent()),
      child: CoconutScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<CoconutBloc, CoconutState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<CoconutBloc, CoconutState,
                              CoconutModel?>(
                            selector: (state) => state.coconutModelObj,
                            builder: (context, coconutModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    coconutModelObj?.coconutItemList.length ??
                                        0,
                                itemBuilder: (context, index) {
                                  CoconutItemModel model =
                                      coconutModelObj?.coconutItemList[index] ??
                                          CoconutItemModel();
                                  return CoconutItemWidget(
                                    model,
                                  );
                                },
                              );
