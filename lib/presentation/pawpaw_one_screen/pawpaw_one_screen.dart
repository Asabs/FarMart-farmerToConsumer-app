import '../pawpaw_one_screen/widgets/pawpaw_one_item_widget.dart';
import 'bloc/pawpaw_one_bloc.dart';
import 'models/pawpaw_one_item_model.dart';
import 'models/pawpaw_one_model.dart';
...
class PawpawOneScreen extends StatelessWidget {
  PawpawOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PawpawOneBloc>(
      create: (context) => PawpawOneBloc(PawpawOneState(
        pawpawOneModelObj: PawpawOneModel(),
      ))
        ..add(PawpawOneInitialEvent()),
      child: PawpawOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<PawpawOneBloc, PawpawOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<PawpawOneBloc, PawpawOneState,
                              PawpawOneModel?>(
                            selector: (state) => state.pawpawOneModelObj,
                            builder: (context, pawpawOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: pawpawOneModelObj
                                        ?.pawpawOneItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  PawpawOneItemModel model = pawpawOneModelObj
                                          ?.pawpawOneItemList[index] ??
                                      PawpawOneItemModel();
                                  return PawpawOneItemWidget(
                                    model,
                                  );
                                },
                              );
