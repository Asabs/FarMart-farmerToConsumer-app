import '../pineapple_one_screen/widgets/pineapple_one_item_widget.dart';
import 'bloc/pineapple_one_bloc.dart';
import 'models/pineapple_one_item_model.dart';
import 'models/pineapple_one_model.dart';
...
class PineappleOneScreen extends StatelessWidget {
  PineappleOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PineappleOneBloc>(
      create: (context) => PineappleOneBloc(PineappleOneState(
        pineappleOneModelObj: PineappleOneModel(),
      ))
        ..add(PineappleOneInitialEvent()),
      child: PineappleOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<PineappleOneBloc, PineappleOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<PineappleOneBloc,
                              PineappleOneState, PineappleOneModel?>(
                            selector: (state) => state.pineappleOneModelObj,
                            builder: (context, pineappleOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: pineappleOneModelObj
                                        ?.pineappleOneItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  PineappleOneItemModel model =
                                      pineappleOneModelObj
                                              ?.pineappleOneItemList[index] ??
                                          PineappleOneItemModel();
                                  return PineappleOneItemWidget(
                                    model,
                                  );
                                },
                              );
