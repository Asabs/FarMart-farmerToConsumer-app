import '../pawpaw_screen/widgets/pawpaw_item_widget.dart';
import 'bloc/pawpaw_bloc.dart';
import 'models/pawpaw_item_model.dart';
import 'models/pawpaw_model.dart';
...
class PawpawScreen extends StatelessWidget {
  PawpawScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PawpawBloc>(
      create: (context) => PawpawBloc(PawpawState(
        pawpawModelObj: PawpawModel(),
      ))
        ..add(PawpawInitialEvent()),
      child: PawpawScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<PawpawBloc, PawpawState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<PawpawBloc, PawpawState,
                              PawpawModel?>(
                            selector: (state) => state.pawpawModelObj,
                            builder: (context, pawpawModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    pawpawModelObj?.pawpawItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  PawpawItemModel model =
                                      pawpawModelObj?.pawpawItemList[index] ??
                                          PawpawItemModel();
                                  return PawpawItemWidget(
                                    model,
                                  );
                                },
                              );
