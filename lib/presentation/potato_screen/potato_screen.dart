import '../potato_screen/widgets/potato_item_widget.dart';
import 'bloc/potato_bloc.dart';
...
class PotatoScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<PotatoBloc>(
      create: (context) => PotatoBloc(PotatoState(
        potatoModelObj: PotatoModel(),
      ))
        ..add(PotatoInitialEvent()),
      child: PotatoScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<PotatoBloc, PotatoState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<PotatoBloc, PotatoState,
                              PotatoModel?>(
                            selector: (state) => state.potatoModelObj,
                            builder: (context, potatoModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    potatoModelObj?.potatoItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  PotatoItemModel model =
                                      potatoModelObj?.potatoItemList[index] ??
                                          PotatoItemModel();
                                  return PotatoItemWidget(
                                    model,
                                  );
                                },
                              );
