import '../cocoyam_screen/widgets/cocoyam_item_widget.dart';
import 'bloc/cocoyam_bloc.dart';
import 'models/cocoyam_item_model.dart';
import 'models/cocoyam_model.dart';
...
class CocoyamScreen extends StatelessWidget {
  CocoyamScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<CocoyamBloc>(
      create: (context) => CocoyamBloc(CocoyamState(
        cocoyamModelObj: CocoyamModel(),
      ))
        ..add(CocoyamInitialEvent()),
      child: CocoyamScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<CocoyamBloc, CocoyamState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<CocoyamBloc, CocoyamState,
                              CocoyamModel?>(
                            selector: (state) => state.cocoyamModelObj,
                            builder: (context, cocoyamModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    cocoyamModelObj?.cocoyamItemList.length ??
                                        0,
                                itemBuilder: (context, index) {
                                  CocoyamItemModel model =
                                      cocoyamModelObj?.cocoyamItemList[index] ??
                                          CocoyamItemModel();
                                  return CocoyamItemWidget(
                                    model,
                                  );
                                },
                              );
