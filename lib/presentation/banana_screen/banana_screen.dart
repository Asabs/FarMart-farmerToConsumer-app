import '../banana_screen/widgets/banana_item_widget.dart';
import 'bloc/banana_bloc.dart';
import 'models/banana_item_model.dart';
import 'models/banana_model.dart';
...
class BananaScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<BananaBloc>(
      create: (context) => BananaBloc(BananaState(
        bananaModelObj: BananaModel(),
      ))
        ..add(BananaInitialEvent()),
      child: BananaScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<BananaBloc, BananaState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<BananaBloc, BananaState,
                              BananaModel?>(
                            selector: (state) => state.bananaModelObj,
                            builder: (context, bananaModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    bananaModelObj?.bananaItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  BananaItemModel model =
                                      bananaModelObj?.bananaItemList[index] ??
                                          BananaItemModel();
                                  return BananaItemWidget(
                                    model,
                                  );
                                },
                              );
