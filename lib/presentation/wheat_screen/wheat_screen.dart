import '../wheat_screen/widgets/wheat_item_widget.dart';
import 'bloc/wheat_bloc.dart';
...
class WheatScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<WheatBloc>(
      create: (context) => WheatBloc(WheatState(
        wheatModelObj: WheatModel(),
      ))
        ..add(WheatInitialEvent()),
      child: WheatScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<WheatBloc, WheatState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child:
                              BlocSelector<WheatBloc, WheatState, WheatModel?>(
                            selector: (state) => state.wheatModelObj,
                            builder: (context, wheatModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    wheatModelObj?.wheatItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  WheatItemModel model =
                                      wheatModelObj?.wheatItemList[index] ??
                                          WheatItemModel();
                                  return WheatItemWidget(
                                    model,
                                  );
                                },
                              );
