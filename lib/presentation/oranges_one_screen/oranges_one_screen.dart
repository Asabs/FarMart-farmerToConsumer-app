import '../oranges_one_screen/widgets/oranges_one_item_widget.dart';
import 'bloc/oranges_one_bloc.dart';
import 'models/oranges_one_item_model.dart';
import 'models/oranges_one_model.dart';
...
class OrangesOneScreen extends StatelessWidget {
  OrangesOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<OrangesOneBloc>(
      create: (context) => OrangesOneBloc(OrangesOneState(
        orangesOneModelObj: OrangesOneModel(),
      ))
        ..add(OrangesOneInitialEvent()),
      child: OrangesOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<OrangesOneBloc, OrangesOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<OrangesOneBloc, OrangesOneState,
                              OrangesOneModel?>(
                            selector: (state) => state.orangesOneModelObj,
                            builder: (context, orangesOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: orangesOneModelObj
                                        ?.orangesOneItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  OrangesOneItemModel model = orangesOneModelObj
                                          ?.orangesOneItemList[index] ??
                                      OrangesOneItemModel();
                                  return OrangesOneItemWidget(
                                    model,
                                  );
                                },
                              );
