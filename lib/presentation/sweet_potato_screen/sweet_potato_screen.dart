import '../sweet_potato_screen/widgets/sweet_potato_item_widget.dart';
import 'bloc/sweet_potato_bloc.dart';
import 'models/sweet_potato_item_model.dart';
import 'models/sweet_potato_model.dart';
...
class SweetPotatoScreen extends StatelessWidget {
  SweetPotatoScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SweetPotatoBloc>(
      create: (context) => SweetPotatoBloc(SweetPotatoState(
        sweetPotatoModelObj: SweetPotatoModel(),
      ))
        ..add(SweetPotatoInitialEvent()),
      child: SweetPotatoScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<SweetPotatoBloc, SweetPotatoState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<SweetPotatoBloc, SweetPotatoState,
                              SweetPotatoModel?>(
                            selector: (state) => state.sweetPotatoModelObj,
                            builder: (context, sweetPotatoModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: sweetPotatoModelObj
                                        ?.sweetPotatoItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  SweetPotatoItemModel model =
                                      sweetPotatoModelObj
                                              ?.sweetPotatoItemList[index] ??
                                          SweetPotatoItemModel();
                                  return SweetPotatoItemWidget(
                                    model,
                                  );
                                },
                              );
