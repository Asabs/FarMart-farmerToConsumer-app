import '../beans_screen/widgets/beans_item_widget.dart';
import 'bloc/beans_bloc.dart';
import 'models/beans_item_model.dart';
import 'models/beans_model.dart';
...
class BeansScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<BeansBloc>(
      create: (context) => BeansBloc(BeansState(
        beansModelObj: BeansModel(),
      ))
        ..add(BeansInitialEvent()),
      child: BeansScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<BeansBloc, BeansState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child:
                              BlocSelector<BeansBloc, BeansState, BeansModel?>(
                            selector: (state) => state.beansModelObj,
                            builder: (context, beansModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    beansModelObj?.beansItemList.length ?? 0,
                                itemBuilder: (context, index) {
                                  BeansItemModel model =
                                      beansModelObj?.beansItemList[index] ??
                                          BeansItemModel();
                                  return BeansItemWidget(
                                    model,
                                  );
                                },
                              );
