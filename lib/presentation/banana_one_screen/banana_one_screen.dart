import '../banana_one_screen/widgets/banana_one_item_widget.dart';
import 'bloc/banana_one_bloc.dart';
import 'models/banana_one_item_model.dart';
import 'models/banana_one_model.dart';
...
class BananaOneScreen extends StatelessWidget {
  BananaOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<BananaOneBloc>(
      create: (context) => BananaOneBloc(BananaOneState(
        bananaOneModelObj: BananaOneModel(),
      ))
        ..add(BananaOneInitialEvent()),
      child: BananaOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<BananaOneBloc, BananaOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<BananaOneBloc, BananaOneState,
                              BananaOneModel?>(
                            selector: (state) => state.bananaOneModelObj,
                            builder: (context, bananaOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: bananaOneModelObj
                                        ?.bananaOneItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  BananaOneItemModel model = bananaOneModelObj
                                          ?.bananaOneItemList[index] ??
                                      BananaOneItemModel();
                                  return BananaOneItemWidget(
                                    model,
                                  );
                                },
                              );
