import '../oranges_screen/widgets/oranges_item_widget.dart';
import 'bloc/oranges_bloc.dart';
import 'models/oranges_item_model.dart';
import 'models/oranges_model.dart';
...
class OrangesScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<OrangesBloc>(
      create: (context) => OrangesBloc(OrangesState(
        orangesModelObj: OrangesModel(),
      ))
        ..add(OrangesInitialEvent()),
      child: OrangesScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<OrangesBloc, OrangesState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<OrangesBloc, OrangesState,
                              OrangesModel?>(
                            selector: (state) => state.orangesModelObj,
                            builder: (context, orangesModelObj) {
                              return ListView.separated(
                                ...
                                itemCount:
                                    orangesModelObj?.orangesItemList.length ??
                                        0,
                                itemBuilder: (context, index) {
                                  OrangesItemModel model =
                                      orangesModelObj?.orangesItemList[index] ??
                                          OrangesItemModel();
                                  return OrangesItemWidget(
                                    model,
                                  );
                                },
                              );
