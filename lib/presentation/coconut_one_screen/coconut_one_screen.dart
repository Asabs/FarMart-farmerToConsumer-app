import '../coconut_one_screen/widgets/coconut_one_item_widget.dart';
import 'bloc/coconut_one_bloc.dart';
import 'models/coconut_one_item_model.dart';
import 'models/coconut_one_model.dart';
...
class CoconutOneScreen extends StatelessWidget {
  CoconutOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<CoconutOneBloc>(
      create: (context) => CoconutOneBloc(CoconutOneState(
        coconutOneModelObj: CoconutOneModel(),
      ))
        ..add(CoconutOneInitialEvent()),
      child: CoconutOneScreen(),
    );
  }
                    ...
                    CustomAppBar(
                      ...
                      title: SizedBox(
                        ...
                        child: Stack(
                          alignment: Alignment.topLeft,
                          children: [
                            BlocSelector<CoconutOneBloc, CoconutOneState,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: BlocSelector<CoconutOneBloc, CoconutOneState,
                              CoconutOneModel?>(
                            selector: (state) => state.coconutOneModelObj,
                            builder: (context, coconutOneModelObj) {
                              return ListView.separated(
                                ...
                                itemCount: coconutOneModelObj
                                        ?.coconutOneItemList.length ??
                                    0,
                                itemBuilder: (context, index) {
                                  CoconutOneItemModel model = coconutOneModelObj
                                          ?.coconutOneItemList[index] ??
                                      CoconutOneItemModel();
                                  return CoconutOneItemWidget(
                                    model,
                                  );
                                },
                              );
