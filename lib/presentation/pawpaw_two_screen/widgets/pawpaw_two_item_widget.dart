...
class PawpawTwoItemWidget extends StatelessWidget {
  PawpawTwoItemWidget(
    this.pawpawTwoItemModelObj, {
    Key? key,
  }) : super(
          key: key,
        );

  PawpawTwoItemModel pawpawTwoItemModelObj;
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            CustomImageView(
              imagePath: ImageConstant.imgImages217,
